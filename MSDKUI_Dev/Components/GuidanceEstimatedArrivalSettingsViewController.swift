        ...
        data = [
            ...
            SettingsItem(title: "With all properties",
                         configuration: Settings(estimatedTimeOfArrival: .distantFuture,
                                                 ...
                                                 primaryInfoTextColor: .colorForeground,
                                                 secondaryInfoTextColor: .colorForegroundSecondary)),
            SettingsItem(title: "Without time of arrival",
                         configuration: Settings(estimatedTimeOfArrival: nil,
                                                 estimatedTimeOfArrivalFormatter: .currentShortTimeFormatter,
                                                 duration: Measurement(value: 17.1, unit: .hours),
                                                 durationFormatter: .currentMediumUnitFormatter,
                                                 ...
                                                 primaryInfoTextColor: .colorForeground,
                                                 secondaryInfoTextColor: .colorForegroundSecondary)),
            SettingsItem(title: "Without duration",
                         configuration: Settings(estimatedTimeOfArrival: .distantFuture,
                                                 estimatedTimeOfArrivalFormatter: .currentShortTimeFormatter,
                                                 duration: nil,
                                                 durationFormatter: .currentMediumUnitFormatter,
            ...
            SettingsItem(title: "Without distance",
                         configuration: Settings(estimatedTimeOfArrival: .distantFuture,
                                                 ...
                                                 primaryInfoTextColor: .colorForeground,
                                                 secondaryInfoTextColor: .colorForegroundSecondary)),
            SettingsItem(title: "Left aligned, red, green",
                         configuration: Settings(estimatedTimeOfArrival: .distantFuture,
                                                 estimatedTimeOfArrivalFormatter: .currentShortTimeFormatter,
                                                 duration: Measurement(value: 17.1, unit: .hours),
                                                 durationFormatter: .currentMediumUnitFormatter,
            ...
            SettingsItem(title: "Center aligned, brown, orange",
                         configuration: Settings(estimatedTimeOfArrival: .distantFuture,
                                                 estimatedTimeOfArrivalFormatter: .currentShortTimeFormatter,
                                                 duration: Measurement(value: 17.1, unit: .hours),
                                                 durationFormatter: .currentMediumUnitFormatter,
            ...
            SettingsItem(title: "Right aligned, blue, purple",
                         configuration: Settings(estimatedTimeOfArrival: .distantFuture,
                                                 estimatedTimeOfArrivalFormatter: .currentShortTimeFormatter,
                                                 duration: Measurement(value: 17.1, unit: .hours),
                                                 durationFormatter: .currentMediumUnitFormatter,
            ...
            SettingsItem(title: "Long date formatter (.timeStyle = .long)",
                         configuration: Settings(estimatedTimeOfArrival: .distantFuture,
                                                 ...
                                                 primaryInfoTextColor: .colorForeground,
                                                 secondaryInfoTextColor: .colorForegroundSecondary)),
            SettingsItem(title: "Basic measurement formatter (MeasurementFormatter())",
                         configuration: Settings(estimatedTimeOfArrival: .distantFuture,
                                                 estimatedTimeOfArrivalFormatter: .currentShortTimeFormatter,
                                                 duration: Measurement(value: 17.1, unit: .hours),
