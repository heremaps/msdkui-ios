...
- [How to Run Demo App](#how-to-run-the-demo-app)
...
- In the repository root folder (where the Podfile is located) run via Terminal:
...
For this Quick Start app, we have used Xcode 10 and Swift 4.2. Start Xcode and select:
...
>**Note:** The above points to the public MSDKUI podspec which may not exist yet. In case of trouble, please point to the local MSDKUI.podspec: If your project lives in the same folder as the example apps, this would be: `pod 'MSDKUI', :path => '../../../'` - for example.
