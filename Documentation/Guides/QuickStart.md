...
- Make sure your application's _Deployment Target_ is higher or equal to the HERE Mobile SDK UI Kit minimum supported version, the minimum supported version is iOS 10.0.
...
By accessing the `waypointList` properties we can easily make adjustments to this UI Kit component and customize its look and feel on-the-fly. In this case, we change the default white-on-black text to appear colored.
