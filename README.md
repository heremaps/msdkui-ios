...
### iOS Environment
- The HERE Mobile SDK UI Kit supports Xcode 10 and Swift 4.2.
...
## Documentation
- The _API Reference_ can be built locally using the command line, see [Contribution Guide](Documentation/Guides/Contribution.md).
...
- A more complex and fully functional _demo app_ can be found in the downloaded HERE Mobile SDK UI Kit package [here](Demo/).
