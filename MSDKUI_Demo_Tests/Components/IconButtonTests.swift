...
class IconButtonTests: XCTestCase {
    ...
    func testCallback() {
        ...
        button.addTarget(self, action: #selector(callback(sender:)), for: .touchUpInside)
    ...
    // The button tap handler method
    @objc private func callback(sender _: UIButton) {
        isTapped = true
    }
}
