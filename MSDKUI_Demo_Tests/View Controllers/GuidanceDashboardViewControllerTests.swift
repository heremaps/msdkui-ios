...
final class GuidanceDashboardViewControllerTests: XCTestCase {
    ...
    var dashboardViewController: GuidanceDashboardViewController?
    ...
    let mockDelegate = GuidanceDashboardViewControllerDelegateMock() // swiftlint:disable:this weak_delegate
    ...
    override func setUp() {
        ...
        // Sets the controller under test as root view controller to test orientation changes
    ...
    override func tearDown() {
        ...
        // Restores original root view controller
    ...
    func testStopNavigationButton() throws {
        ...
        XCTAssertEqual(dashboardViewController?.stopNavigationButton.accessibilityIdentifier, "GuidanceViewController.stopNavigationButton",
    ...
    func testPullView() {
        ...
        XCTAssertEqual(dashboardViewController?.pullView.backgroundColor, .colorHint, "It has the pull view with correct color")
    ...
    func testTableView() throws {
        ...
        XCTAssertEqual(dashboardViewController?.tableView.separatorStyle, UITableViewCellSeparatorStyle.none, "It doesn't have cell separators")
    }
    ...
    func testEstimatedArrivalViewWhenDeviceOrientationChanges() {
        XCUIDevice.shared.orientation = .portrait
    ...
    func testWhenGuidanceEstimatedArrivalMonitorDidChangeTimeOfArrivalDistanceDurationIsTriggeredWithIncompleteModel() throws {
        ...
        XCTAssertLocalized(dashboardViewController?.estimatedArrivalView.distanceLabel.text, key: "msdkui_value_not_available", bundle: .MSDKUI,
