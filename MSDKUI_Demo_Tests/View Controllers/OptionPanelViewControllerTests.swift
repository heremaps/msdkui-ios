...
final class OptionPanelViewControllerTests: XCTestCase {
    /// The Option Panel View Controller under test.
    var viewControllerUnderTest: OptionPanelViewController?
    ...
    override func setUp() {
        ...
        viewControllerUnderTest = UIStoryboard.instantiateFromMainStoryboard() as OptionPanelViewController
    ...
    func testAccessibilityIdentifiers() {
        XCTAssertEqual(viewControllerUnderTest?.backButton.accessibilityIdentifier, "RouteViewController.back",
                       "The back button should have the correct accessibility identifier")

        XCTAssertEqual(viewControllerUnderTest?.scrollView.accessibilityIdentifier, "RouteViewController.scrollView",
    ...
    func testBackButtonTapAfterOptionChange() {
        ...
        viewControllerUnderTest?.onOptionChanged(OptionItem())
    ...
    /// Tests the conformance with the PickerViewDelegate protocol.
    func testMakeLabel() {
    ...
    func testViewDidLoadWithRouteTypeOptionsPanel() {
        ...
        XCTAssertTrue(panel.delegate === viewControllerUnderTest,
