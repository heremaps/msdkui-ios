...
final class AboutTableViewDataSourceTests: XCTestCase {
    ...
    func testItem() throws {
        ...
        XCTAssertEqual(firstItem.description, "2.0.0", "It has the correct description")
        ...
        XCTAssertEqual(secondItem.description, "2.0.0", "It has the correct description")
    ...
    func testTableViewCellForRowAt() throws {
        ...
        XCTAssertEqual(cell?.detailTextLabel?.text, "2.0.0", "It has the correct detail text")
    }
}
