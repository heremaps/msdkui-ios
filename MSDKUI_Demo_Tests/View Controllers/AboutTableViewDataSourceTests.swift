...
final class AboutTableViewDataSourceTests: XCTestCase {
    ...
    var dataSource: AboutTableViewDataSource?
    ...
    func testItem() throws {
        ...
        XCTAssertEqual(firstItem.description, "1.4.0", "It has the correct description")
        ...
        XCTAssertEqual(secondItem.description, "1.4.0", "It has the correct description")
        ...
        XCTAssertTrue(thirdItem.description.contains("3.8.0"), "It has the correct description")
    ...
    func testTableViewCellForRowAt() throws {
        ...
        XCTAssertEqual(cell?.detailTextLabel?.text, "1.4.0", "It has the correct detail text")
    }
}
