...
final class AboutTableViewDataSourceTests: XCTestCase {
    ...
    func testItem() throws {
        ...
        XCTAssertEqual(firstItem.description, "2.1.9", "It has the correct description")
        ...
        XCTAssertEqual(secondItem.description, "2.1.9", "It has the correct description")
        ...
        XCTAssertTrue(thirdItem.description.contains("3.19.2"), "It has the correct description")
    ...
    func testTableViewCellForRowAt() throws {
        ...
        XCTAssertEqual(cell?.detailTextLabel?.text, "2.1.9", "It has the correct detail text")
    }
}
