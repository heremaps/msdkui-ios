...
class WaypointViewControllerTests: XCTestCase {
    ...
    func testReverseGeoCoding() {
        ...
        let expectations = [
            ...
            "47.48689, -26.96417",
            "ulica Dąbska, 70-789 Szczecin, Poland",
            "Invalidenstraße 116, 10115 Berlin, Germany",
            "Baullstulvegen, 2635 Tretten, Norway",
            "Greenland"
        ]
        ...
        for index in 0 ..< coordinates.count {
            ...
            print("Entry name: '\(String(describing: viewControllerUnderTest?.waypointLabel.text))' vs expectation: '\(expectations[index])'")
