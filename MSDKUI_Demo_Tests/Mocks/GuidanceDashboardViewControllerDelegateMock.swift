...
final class GuidanceDashboardViewControllerDelegateMock {
    ...
    private(set) var lastController: GuidanceDashboardViewController?
    private(set) var lastItem: GuidanceDashboardTableViewDataSource.Item?
}
