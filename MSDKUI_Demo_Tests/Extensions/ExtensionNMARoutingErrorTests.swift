...
final class ExtensionNMARoutingErrorTests: XCTestCase {
    ...
    func testNoneDebugDescription() {
        XCTAssertEqual(NMARoutingError.none.debugDescription,
    ...
    func testUnknownDebugDescription() {
        XCTAssertEqual(NMARoutingError.unknown.debugDescription,
    ...
    func testOutOfMemoryDebugDescription() {
        XCTAssertEqual(NMARoutingError.outOfMemory.debugDescription,
    ...
    func testInvalidParametersDebugDescription() {
        XCTAssertEqual(NMARoutingError.invalidParameters.debugDescription,
    ...
    func testInvalidOperationDebugDescription() {
        XCTAssertEqual(NMARoutingError.invalidOperation.debugDescription,
    ...
    func testGraphDisconnectedDebugDescription() {
        XCTAssertEqual(NMARoutingError.graphDisconnected.debugDescription,
    ...
    func testGraphDisconnectedCheckOptionsDebugDescription() {
        XCTAssertEqual(NMARoutingError.graphDisconnectedCheckOptions.debugDescription,
    ...
    func testNoStartPointDebugDescription() {
        XCTAssertEqual(NMARoutingError.noStartPoint.debugDescription,
    ...
    func testNoEndPointDebugDescription() {
        XCTAssertEqual(NMARoutingError.noEndPoint.debugDescription,
    ...
    func testNoEndPointCheckOptionsDebugDescription() {
        XCTAssertEqual(NMARoutingError.noEndPointCheckOptions.debugDescription,
    ...
    func testCannotDoPedestrianDebugDescription() {
        XCTAssertEqual(NMARoutingError.cannotDoPedestrian.debugDescription,
    ...
    func testRoutingCancelledDebugDescription() {
        XCTAssertEqual(NMARoutingError.routingCancelled.debugDescription,
    ...
    func testViolatesOptionsDebugDescription() {
        XCTAssertEqual(NMARoutingError.violatesOptions.debugDescription,
    ...
    func testRouteCorruptedDebugDescription() {
        XCTAssertEqual(NMARoutingError.routeCorrupted.debugDescription,
    ...
    func testInvalidCredentialsDebugDescription() {
        XCTAssertEqual(NMARoutingError.invalidCredentials.debugDescription,
    ...
    func testInsufficientMapDataDebugDescription() {
        XCTAssertEqual(NMARoutingError.insufficientMapData.debugDescription,
    ...
    func testNetworkCommunicationDebugDescription() {
        XCTAssertEqual(NMARoutingError.networkCommunication.debugDescription,
    ...
    func testUnsupportedMapVersionDebugDescription() {
        XCTAssertEqual(NMARoutingError.unsupportedMapVersion.debugDescription,
