...
class GuidanceManeuverPanelTests: XCTestCase {
    ...
    private var panel = GuidanceManeuverPanel(frame: CGRect(origin: .zero, size: CGSize(width: 375.0, height: 139.0)))
    ...
    func testInitialPanelHeight() {
        XCTAssertEqual(panel.frame.size.height, 139.0, "The initial panel height is wrong!")
    }
    ...
    func testPanelWithInfo1inPortrait() {
        ...
        XCTAssertEqual(panel.intrinsicContentSize.height, 139.0, "The panel height with Info1 is wrong!")

        // Are the data set correctly?
        XCTAssertFalse(panel.info1Labels[GuidanceManeuverPanel.Orientation.portrait.rawValue].isHidden,
                       "The panel landscape info1 label is hidden!")

        XCTAssertFalse(panel.info1Labels[GuidanceManeuverPanel.Orientation.landscape.rawValue].isHidden,
                       "The panel landscape info1 label is hidden!")
    ...
    func testPanelWithoutInfo1inPortrait() {
        ...
        XCTAssertLessThan(panel.intrinsicContentSize.height, 139.0, "The panel height without Info1 is wrong!")

        // Are the data set correctly?
        XCTAssertTrue(panel.info1Labels[GuidanceManeuverPanel.Orientation.portrait.rawValue].isHidden,
                      "The panel landscape info1 label is not hidden!")

        XCTAssertTrue(panel.info1Labels[GuidanceManeuverPanel.Orientation.landscape.rawValue].isHidden,
                      "The panel landscape info1 label is not hidden!")
    ...
    func testHighlightColor() {
        ...
        XCTAssertEqual(panel.info2Labels[GuidanceManeuverPanel.Orientation.portrait.rawValue].textColor, UIColor.red,
                       "The portrait Info2 color is wrong!")

        XCTAssertEqual(panel.info2Labels[GuidanceManeuverPanel.Orientation.landscape.rawValue].textColor, UIColor.red,
    ...
    private func checkData(_ data: GuidanceManeuverData, line: UInt = #line) {
        XCTAssertNotNil(panel.maneuverImageViews[GuidanceManeuverPanel.Orientation.portrait.rawValue].image,
                        "The portrait maneuver image is not set!",
                        line: line)

        XCTAssertEqual(panel.roadIconViews[GuidanceManeuverPanel.Orientation.portrait.rawValue].image,
                       mockNextRoadIcon,
                       "The portrait highway image is not set!",
                       line: line)

        XCTAssertEqual(panel.distanceLabels[GuidanceManeuverPanel.Orientation.portrait.rawValue].text,
                       data.distance,
                       "The portrait distance data is wrong!",
                       line: line)

        XCTAssertEqual(panel.info1Labels[GuidanceManeuverPanel.Orientation.portrait.rawValue].text,
                       data.info1,
                       "The portrait distance info1 is wrong!",
                       line: line)

        XCTAssertEqual(panel.info2Labels[GuidanceManeuverPanel.Orientation.portrait.rawValue].text,
                       data.info2,
                       "The portrait distance info2 is wrong!",
                       line: line)

        XCTAssertNotNil(panel.maneuverImageViews[GuidanceManeuverPanel.Orientation.landscape.rawValue].image,
                        "The landscape maneuver image is not set!",
                        line: line)

        XCTAssertEqual(panel.roadIconViews[GuidanceManeuverPanel.Orientation.landscape.rawValue].image,
                       mockNextRoadIcon,
                       "The landscape highway image is not set!",
                       line: line)

        XCTAssertEqual(panel.distanceLabels[GuidanceManeuverPanel.Orientation.landscape.rawValue].text,
                       data.distance,
                       "The landscape distance data is wrong!",
                       line: line)

        XCTAssertEqual(panel.info1Labels[GuidanceManeuverPanel.Orientation.landscape.rawValue].text,
                       data.info1,
                       "The landscape distance info1 is wrong!",
                       line: line)

        XCTAssertEqual(panel.info2Labels[GuidanceManeuverPanel.Orientation.landscape.rawValue].text,
                       data.info2,
    ...
    private func checkStyle(backgroundColor: UIColor, foregroundColor: UIColor, line: UInt = #line) {
        XCTAssertEqual(panel.views[GuidanceManeuverPanel.Orientation.portrait.rawValue].backgroundColor,
                       backgroundColor,
                       "The portrait panel backgroundColor is wrong!",
                       line: line)
        XCTAssertEqual(panel.views[GuidanceManeuverPanel.Orientation.landscape.rawValue].backgroundColor,
                       backgroundColor,
                       "The landscape panel backgroundColor is wrong!",
                       line: line)

        XCTAssertEqual(panel.distanceLabels[GuidanceManeuverPanel.Orientation.portrait.rawValue].textColor,
                       foregroundColor,
                       "The portrait distance label text color is wrong!",
                       line: line)
        XCTAssertEqual(panel.distanceLabels[GuidanceManeuverPanel.Orientation.landscape.rawValue].textColor,
                       foregroundColor,
                       "The landscape distance label text color is wrong!",
                       line: line)

        XCTAssertEqual(panel.info1Labels[GuidanceManeuverPanel.Orientation.portrait.rawValue].textColor,
                       foregroundColor,
                       "The portrait info1 label text color is wrong!",
                       line: line)
        XCTAssertEqual(panel.info1Labels[GuidanceManeuverPanel.Orientation.landscape.rawValue].textColor,
                       foregroundColor,
                       "The landscape info1 label text color is wrong!",
                       line: line)

        XCTAssertEqual(panel.info2Labels[GuidanceManeuverPanel.Orientation.portrait.rawValue].textColor,
                       foregroundColor,
                       "The portrait info2 label text color is wrong!",
                       line: line)
        XCTAssertEqual(panel.info2Labels[GuidanceManeuverPanel.Orientation.landscape.rawValue].textColor,
                       foregroundColor,
                       "The landscape info2 label text color is wrong!",
                       line: line)

        XCTAssertEqual(panel.noDataLabels[GuidanceManeuverPanel.Orientation.portrait.rawValue].textColor,
                       foregroundColor,
                       "The portrait no data label text color is wrong!",
                       line: line)
        XCTAssertEqual(panel.noDataLabels[GuidanceManeuverPanel.Orientation.landscape.rawValue].textColor,
                       foregroundColor,
                       "The landscape no data label text color is wrong!",
                       line: line)

        XCTAssertEqual(panel.maneuverImageViews[GuidanceManeuverPanel.Orientation.portrait.rawValue].tintColor,
                       foregroundColor,
                       "The portrait maneuver icon color is wrong!",
                       line: line)
        XCTAssertEqual(panel.maneuverImageViews[GuidanceManeuverPanel.Orientation.landscape.rawValue].tintColor,
                       foregroundColor,
                       "The landscape maneuver icon color is wrong!",
                       line: line)

        XCTAssertEqual(panel.roadIconViews[GuidanceManeuverPanel.Orientation.portrait.rawValue].tintColor,
                       foregroundColor,
                       "The portrait road icon color is wrong!",
                       line: line)
        XCTAssertEqual(panel.roadIconViews[GuidanceManeuverPanel.Orientation.landscape.rawValue].tintColor,
                       foregroundColor,
                       "The landscape road icon color is wrong!",
                       line: line)

        XCTAssertEqual(panel.noDataImageViews[GuidanceManeuverPanel.Orientation.portrait.rawValue].tintColor,
                       foregroundColor,
                       "The portrait no data icon color is wrong!",
                       line: line)
        XCTAssertEqual(panel.noDataImageViews[GuidanceManeuverPanel.Orientation.landscape.rawValue].tintColor,
                       foregroundColor,
                       "The landscape no data icon color is wrong!",
                       line: line)

        XCTAssertEqual(panel.busyIndicators[GuidanceManeuverPanel.Orientation.portrait.rawValue].color,
                       foregroundColor,
                       "The portrait busy indicator color is wrong!",
                       line: line)
        XCTAssertEqual(panel.busyIndicators[GuidanceManeuverPanel.Orientation.landscape.rawValue].color,
                       foregroundColor,
