...
class RoutingOptionsPanelTests: XCTestCase {
    // The panel
    ...
    func onOptionCreated(_ item: OptionItem) {
        ...
        print("onOptionCreated called: selectedItemIndexes = \(item.selectedItemIndexes ?? [])")

        XCTAssertEqual(item.selectedItemIndexes, [1, 7], "Not the expected options selected!")
    ...
    func onOptionChanged(_ item: OptionItem) {
        ...
        print("onOptionChanged called: selectedItemIndexes = \(item.selectedItemIndexes ?? [])")

        XCTAssertEqual(item.selectedItemIndexes, [0], "Not the expected options selected!")
