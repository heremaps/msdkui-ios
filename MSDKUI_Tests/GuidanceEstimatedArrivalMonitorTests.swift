...
final class GuidanceEstimatedArrivalMonitorTests: XCTestCase {
    ...
    /// The estimated arrival monitor under test.
    ...
    /// Tests the behavior when the `.NMAPositioningManagerDidUpdatePosition` notification is triggered with inconsistent distance to destination.
    ...
    /// Tests the behavior when the `.NMAPositioningManagerDidUpdatePosition` notification is triggered with inconsistent travel duration to destination.
