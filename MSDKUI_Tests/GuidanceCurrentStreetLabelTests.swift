...
class GuidanceCurrentStreetLabelTests: XCTestCase {
    /// The view to be tested. Note that it is re-created before each test.
    var labelUnderTest: GuidanceCurrentStreetLabel?
    ...
    /// Tests if the label has the correct default contents insets.
    func testContentsInsets() {
        XCTAssertEqual(labelUnderTest?.contentsInsets, UIEdgeInsets(top: 0, left: 16, bottom: 0, right: 16),
                       "It has the correct contents insets")
    }

    // MARK: - Looking for position state tests
    ...
    func testTextInset() throws {
        ...
        labelUnderTest.contentsInsets = firstInset
        ...
        labelUnderTest.contentsInsets = secondInset
        labelUnderTest.sizeToFit()
    ...
    /// Helper function for testing accessibility of a label instance.
    ...
    /// Helper function for testing style properties of a label instance.
