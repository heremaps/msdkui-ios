...
class ManeuverResourcesTest: XCTestCase {
    ...
    func junctionManeuverTurnTest(maneuverTurn: NMAManeuverTurn, expectedString: String) {
        ...
        let maneuverInstruction: String = maneuverResources!.getManeuverInstruction(index: 0)
    ...
    func maneuverAction(maneuverAction: NMAManeuverAction, expectedString: String) {
    ...
    func maneuverActionTurn(maneuverAction: NMAManeuverAction,
