...
class GuidanceManeuverUtilTests: XCTestCase {
    ...
    // Tests MSDKUI.GuidanceManeuverUtil.getIndex() method
    ...
    // Tests MSDKUI.GuidanceManeuverUtil.areManeuversEqual() method
    ...
    // Tests MSDKUI.GuidanceManeuverUtil.combineStrings() method
    ...
    // Tests GuidanceManeuverUtil.getNextStreet() method:
    // the current maneuver should provide the return string
    ...
    // Tests GuidanceManeuverUtil.getNextStreet() method:
    // the route should provide the return string
    func testGetNextStreetWithRoute() {
        // We need to swizzle the navigation manager for this test as GuidanceManeuverUtil.getNextManeuver() uses it
        swizzleNavigationManagerWithoutNextManeuver()

        // Note that we should get the next street via the route maneuvers
        let nextStreet = GuidanceManeuverUtil.getNextStreet(from: MockUtils.mockRoute().maneuvers![0], fallback: MockUtils.mockRoute())
