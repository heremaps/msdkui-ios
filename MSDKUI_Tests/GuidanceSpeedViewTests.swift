...
final class GuidanceSpeedViewTests: XCTestCase {
    ...
    /// The Speed View under test.
    var speedView = GuidanceSpeedView(frame: CGRect(x: 0, y: 0, width: 200, height: 80))
    ...
    func testViewAccessibility() {
        ...
        XCTAssertEqual(speedView.accessibilityTraits, UIAccessibilityTraitStaticText, "It has the correct accessibility traits")
