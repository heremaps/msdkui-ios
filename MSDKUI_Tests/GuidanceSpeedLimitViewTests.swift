...
final class GuidanceSpeedLimitViewTests: XCTestCase {
    ...
    /// The Speed Limit View under test.
    var speedLimitView = GuidanceSpeedLimitView(frame: CGRect(x: 0, y: 0, width: 200, height: 80))
    ...
    func testViewAccessibility() {
        ...
        XCTAssertEqual(speedLimitView.accessibilityTraits, UIAccessibilityTraitStaticText, "It has the correct accessibility traits")
