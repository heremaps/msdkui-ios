...
final class GuidanceEstimatedArrivalViewTests: XCTestCase {
    ...
    func testHasEstimatedTimeOfArrivalLabel() {
        ...
        XCTAssertLocalized(arrivalView.estimatedTimeOfArrivalLabel.text, key: "msdkui_value_not_available", bundle: .MSDKUI, "It shows dashes as ETA text")
    ...
    func testHasDurationLabel() {
        XCTAssertNotNil(arrivalView.durationLabel, "It has the duration label")
        XCTAssertLocalized(arrivalView.durationLabel.text, key: "msdkui_value_not_available", bundle: .MSDKUI, "It shows dashes as duration text")
    ...
    func testHasDistanceLabel() {
        XCTAssertNotNil(arrivalView.distanceLabel, "It has the distance label")
        XCTAssertLocalized(arrivalView.distanceLabel.text, key: "msdkui_value_not_available", bundle: .MSDKUI, "It shows dashes as distance text")
    ...
    func testWhenConfigureIsTriggeredWhenModelIsEmpty() {
        ...
        XCTAssertFalse(viewModel.isComplete, "It has an incomplete model")
        XCTAssertLocalized(arrivalView.estimatedTimeOfArrivalLabel.text, key: "msdkui_value_not_available", bundle: .MSDKUI, "It shows dashes as ETA text")
        XCTAssertLocalized(arrivalView.distanceLabel.text, key: "msdkui_value_not_available", bundle: .MSDKUI, "It shows dashes as duration text")
        XCTAssertLocalized(arrivalView.durationLabel.text, key: "msdkui_value_not_available", bundle: .MSDKUI, "It shows dashes as distance text")
    }
    ...
    func testViewAccessibility() {
        ...
        XCTAssertEqual(arrivalView.accessibilityTraits, UIAccessibilityTraitStaticText, "It has the correct accessibility traits")
