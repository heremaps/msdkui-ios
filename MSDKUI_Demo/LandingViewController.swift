...
class LandingViewController: UIViewController {
    ...
    /// Handles tapping the the route planner card.
    ///
    ...
    /// Handles tapping the the drive nav card.
    ///
    /// - Parameter sender: The gesture recognizer triggering the action.
    ...
    func setAccessibility() {
        ...
        routePannerView.accessibilityIdentifier = "LandingViewController.routePannerView"
