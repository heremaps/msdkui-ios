...
extension NMAMapView {
    ...
    ///
    /// - Parameter coordinates: The coordinates of marker.
    ...
    func markerBoundingBox(at coordinates: NMAGeoCoordinates?) -> NMAGeoBoundingBox? {
        guard
            ...
            case let topLeftPoint = CGPoint(x: markerPoint.x - 40.0, y: markerPoint.y - 50.0),
            case let bottomRightPoint = CGPoint(x: markerPoint.x + 40.0, y: markerPoint.y + 50.0),
