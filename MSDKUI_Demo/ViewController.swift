...
class ViewController: UIViewController {
    ...
    @IBAction private func reverseItems(_: IconButton) {
        waypointList.reverse()

        calculateRoute()
    }

    @IBAction private func addWaypoint(_: IconButton) {
    ...
    @IBAction private func showOptions(_: IconButton) {
    ...
    @IBAction private func toggleWaypointsVisibility(_: UIBarButtonItem) {
