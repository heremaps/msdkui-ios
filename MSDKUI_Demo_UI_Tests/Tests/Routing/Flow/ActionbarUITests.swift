...
class ActionbarUITests: XCTestCase {
    ...
    func testReorderWaypoint() {
        ...
        ActionbarMatchers.checkWaypointFromLabelHidden(forWaypoint: ActionbarView.waypointListCell(cellNr: 0))
        ...
        // Expand WaypointList
        CoreActions.tapElement("ViewController.rightButton")
        ...
        ActionbarMatchers.checkWaypointToLabelHidden(forWaypoint: ActionbarView.waypointListCell(cellNr: 1))
    ...
    func testReverseWaypointItemsOrder() {
        ...
        ActionbarMatchers.checkWaypointName(
            withId: ActionbarView.waypointListCell(cellNr: 0),
    ...
    func testAddRemoveWaypoints() {
        ...
        ActionbarActions.removeWaypoint(
            element: ActionbarView.waypointListCell(cellNr: 2))
    ...
    func testSelectWaypointOnMap() {
        ...
        ActionbarMatchers.checkWaypointFromLabelDisplayed(forWaypoint: ActionbarView.waypointListCell(cellNr: 0))
        ActionbarMatchers.checkWaypointToLabelDisplayed(forWaypoint: ActionbarView.waypointListCell(cellNr: 1))

        // Tap on "From" waypoint (first cell)
        CoreActions.tap(element: ActionbarView.waypointListCell(cellNr: 0))
