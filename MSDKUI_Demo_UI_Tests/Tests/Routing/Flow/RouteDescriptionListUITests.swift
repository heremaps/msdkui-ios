...
class RouteDescriptionListUITests: XCTestCase {
    ...
    /// This test is designed to test the `RouteDescriptionList`.
    func testRouteDescription() {
        ...
        RouteplannerActions.saveRouteListAccessibilityHints()
        RouteplannerActions.checkRouteListAccessibilityHints()

        // Compare the route preview RouteDescriptionItem data with the saved data
        RouteplannerActions.compareRouteDescriptionData()
    }
    ...
    func testClearWaypoints() {
        ...
        // User is on the landingpage
        Utils.waitFor(element: LandingView.routingPlanner)

        // Tap Route planner
        CoreActions.tap(element: LandingView.routingPlanner)

        // User is on the route planner view
        Utils.waitFor(element: RouteplannerView.routeOverviewMapView)
