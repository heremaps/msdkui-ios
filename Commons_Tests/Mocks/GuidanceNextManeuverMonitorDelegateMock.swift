...
final class GuidanceNextManeuverMonitorDelegateMock {
    ...
    private(set) var lastManeuverIcon: UIImage?
    private(set) var lastDistance: Measurement<UnitLength>?
    private(set) var lastStreetName: String?
}
