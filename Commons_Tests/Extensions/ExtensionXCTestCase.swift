...
extension XCTestCase {
    ...
    func XCTAssertLocalized(_ string: String?, key: String, bundle: Bundle? = .main, _ message: String = "", file: StaticString = #file, line: UInt = #line) {
    ...
    func XCTAssertLocalized(_ string: String?,
        ...
        if arguments.count == 1, let argument = arguments.first {
            localizedString = String(format: localizedFormatKey, argument)
        } else {
            localizedString = String(format: localizedFormatKey, arguments)
        }
