...
@IBDesignable open class GuidanceEstimatedArrivalView: UIView {
    ...
    public func configure(with model: ViewModel) {
        ...
        let missingInformation = "msdkui_value_not_available".localized
    ...
    private func setUpLabels() {
        ...
        estimatedTimeOfArrivalLabel.font = .monospacedDigitSystemFont(ofSize: 22, weight: UIFontWeightBold)
        [durationLabel, distanceLabel].forEach { $0.font = .monospacedDigitSystemFont(ofSize: 15, weight: UIFontWeightRegular) }
    ...
    private func updateViewAccessibilityHint(with information: [String?]) {
        let hint = information.flatMap { $0 }.joined(separator: ", ")
