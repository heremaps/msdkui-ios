...
@IBDesignable open class GuidanceSpeedView: UIView {
    ...
    private func setUpLabels() {
        ...
        speedValueLabel.font = .monospacedDigitSystemFont(ofSize: 22, weight: UIFontWeightBold)
        speedUnitLabel.font = .monospacedDigitSystemFont(ofSize: 15, weight: UIFontWeightRegular)
    }
