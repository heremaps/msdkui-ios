...
/// orientations. The panel listens to the `UIDeviceOrientationDidChange`
...
@IBDesignable open class GuidanceManeuverPanel: UIView {
    ...
    var portraitInfo1LabelDesignHeight = CGFloat(0.0)

    /// The height of portrait Info 2 label as designed.
    var portraitInfo2LabelDesignHeight = CGFloat(0.0)

    /// The height of landscape Info 1 label as designed.
    var landscapeInfo1LabelDesignHeight = CGFloat(0.0)
