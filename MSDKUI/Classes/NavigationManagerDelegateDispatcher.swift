...
open class NavigationManagerDelegateDispatcher: NSObject {
    ...
    fileprivate let delegates = MulticastDelegate<NMANavigationManagerDelegate>()

    /// The NMANavigationManager instance.
    fileprivate let sharedNavigationManager: NMANavigationManager
...
extension NavigationManagerDelegateDispatcher: NavigationManagerDelegateDispatching {
    ...
    fileprivate func updateNavigationManagerDelegate() {
...
extension NavigationManagerDelegateDispatcher: NMANavigationManagerDelegate {
    ...
    public func navigationManager(_ navigationManager: NMANavigationManager, didUpdateRealisticViewsForCurrentManeuver realisticViews: [String: NMAImage]) {
        delegates.invoke {
    ...
    public func navigationManager(_ navigationManager: NMANavigationManager, didUpdateRealisticViewsForNextManeuver realisticViews: [String: NMAImage]) {
        delegates.invoke {
