...
public extension UIScrollView { // swiftlint:disable:this missing_docs
    ...
    func addSubviewsWithVerticalScrolling(_ views: [UIView]) {
        ...
        let widthConstraint = NSLayoutConstraint(item: stackView, attribute: .width, relatedBy: .equal,
