...
/// This class provides the helper methods for all the guidance-related activities.
enum GuidanceManeuverUtil {
    ...
    static func getNextStreet(from maneuver: NMAManeuver?, fallback route: NMARoute?) -> String? {
        ...
        while distance < GuidanceManeuverUtil.nextManeuverThreshold &&
            nextManeuver != nil &&
            nextStreet == nil {
                distance += Int(nextManeuver!.distanceFromPreviousManeuver)
                nextStreet = GuidanceManeuverUtil.combineStrings(maneuver: nextManeuver!,
                                                                 name: nextManeuver!.nextRoadName as String?,
                                                                 number: nextManeuver!.nextRoadNumber as String?)
                nextManeuver = GuidanceManeuverUtil.getNextManeuver(last: nextManeuver, fallback: route)
        }
    ...
    static func combineStrings(maneuver: NMAManeuver, name: String?, number: String?) -> String? {
        ...
        if maneuver.action == .leaveHighway {
